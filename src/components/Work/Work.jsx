...
const Work = () => {
  ...
  return (
    <section
      id="work"
      className="py-16 sm:py-20 lg:py-24 px-5 sm:px-[7vw] lg:px-[10vw] xl:px-[16vw] font-sans relative"
    >
      {/* Section Title */}
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <a
                    ...
                    className="w-full sm:w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 px-4 py-2 rounded-xl lg:text-xl text-sm font-semibold text-center"
                  >
                    View Code
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-1/2 bg-purple-600 hover:bg-gray-800 text-white px-4 py-2 rounded-xl lg:text-xl text-sm font-semibold text-center"
                  >
                    View Live
                  </a>
                </div>
